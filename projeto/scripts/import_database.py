...
def ibama_production_data(repo_path):
    """
    Processa dados de produção do IBAMA a partir de arquivos XLSX, limpando e consolidando os dados.
    
    Parâmetros:
        repo_path (str): Caminho raiz do repositório onde estão as pastas inputs/outputs
